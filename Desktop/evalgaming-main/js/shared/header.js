document.addEventListener('DOMContentLoaded', function() {
    ...
    const headerHTML = `
        <div class="header-container">
            <div class="header-content">
                <img src="${basePath}images/icons/emblem.png" alt="Emblem" style="width: 50px; height: auto; margin-right: 10px;">
    ...
    // Insert header content into the page
    ...
    // Setup dropdown functionality for recruiting
