    ...
    const headerHTML = `
        <div class="header-container">
            <div class="header-content">
                ...
                <nav class="main-nav">
                    <div class="nav-item">
                        <button class="dropdown-btn">COLLEGE RANKINGS</button>
                        <div class="dropdown-content">
                            <a href="${basePath}pages/games/valorant.html">VALORANT</a>
                            <a href="${basePath}pages/games/rocket.html">Rocket League</a>
                            <a href="${basePath}pages/games/smash.html">Super Smash Bros</a>
                        </div>
                    </div>
                    <div class="nav-item">
